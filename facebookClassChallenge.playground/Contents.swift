//FacebookClassChallenge
    ...
    //variables: relationship status, interests, age, followers, birthday
class facebookProfile {
    ...
    init (first : String , last : String , birth : String , relationship : String , interest : String , year : Int, follower : Int ) {
        firstName = first
        lastName = last
        birthPlace = birth
...
var profile = facebookProfile(first : "Mia", last : "Aklufi", birth : "Manhattan", relationship : "Single", interest : "Eating"  , year : 28 , follower : 28)
